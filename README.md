...
<p align="center">
  ...
  <h3 align="center">Covid-19 Case Notify</h3>
...
This is a python app which notifies the user with the number of Covid-19 cases within the country with the web scrapping!
...
- Clone the repo
   ```sh
   git clone https://github.com/Aaryan-R-S/Python-Projects-Covid19-Cases-Notify.git
   ```
- Python Modules
  - `pip install bs4` 
